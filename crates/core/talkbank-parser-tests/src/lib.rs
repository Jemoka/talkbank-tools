...
//!
//! *Spec tests* (in `resources/spec/constructs/` and `resources/spec/errors/`) verify that individual
//! CHAT constructs parse to the expected CST/AST and that invalid input produces
//! the correct error codes. They are generated into this crate by `just spec gen-tree-sitter-tests && just spec gen-rust-tests && just spec gen-error-docs`.
//!
...
//! `talkbank-chat/resources/corpus/reference/`. They catch drift between parsers that spec
...
pub mod golden {
    ...
    /// `cargo run -p talkbank-parser-tests --bin generate-golden-words -- --corpus-root resources/corpus/reference`
    ...
    /// `cargo run -p talkbank-parser-tests --bin generate-golden-main-tiers -- --corpus-root resources/corpus/reference`
    /// after editing the reference corpus to regenerate the list.
    ...
    /// `cargo run -p talkbank-parser-tests --bin generate-golden-mor-tiers -- --corpus-root resources/corpus/reference`
    /// after editing the reference corpus to regenerate the list.
    ...
    /// `cargo run -p talkbank-parser-tests --bin generate-golden-gra-tiers -- --corpus-root resources/corpus/reference`
    /// after editing the reference corpus to regenerate the list.
    ...
    /// `cargo run -p talkbank-parser-tests --bin generate-golden-pho-tiers -- --corpus-root resources/corpus/reference`
    /// after editing the reference corpus to regenerate the list.
    ...
    /// `cargo run -p talkbank-parser-tests --bin generate_golden_sin_tiers -- --corpus-root resources/corpus/reference`
    /// after editing the reference corpus to regenerate the list.
    ...
    /// `cargo run -p talkbank-parser-tests --bin generate_golden_wor_tiers -- --corpus-root resources/corpus/reference`
    /// after editing the reference corpus to regenerate the list.
    ...
    /// `cargo run -p talkbank-parser-tests --bin generate_golden_com_tiers -- --corpus-root resources/corpus/reference`
    /// after editing the reference corpus to regenerate the list.
