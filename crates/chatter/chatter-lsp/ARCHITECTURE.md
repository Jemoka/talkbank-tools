# rust   crates   talkbank lsp   ARCHITECTURE

## Overview
Short summary for `rust/crates/chatter-lsp/ARCHITECTURE.md`. This document is intentionally concise; legacy detail has been trimmed.
