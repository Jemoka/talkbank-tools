...
- **`test/corpus/`** — test cases generated from CHAT format [specifications](../spec/) via `just spec gen-tree-sitter-tests && just spec gen-rust-tests && just spec gen-error-docs` (from repo root)
