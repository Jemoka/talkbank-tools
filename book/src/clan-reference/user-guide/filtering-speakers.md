...
Authoritative parser: `crates/clan/clan-core/src/framework/id_filter.rs`. The language field is a comma-separated list in the underlying `@ID`; the filter matches if any language in the `@ID` matches the pattern.
