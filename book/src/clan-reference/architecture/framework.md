...
The framework (`crates/clan/clan-core/src/framework/`) provides shared infrastructure for all commands.
...
Per `crates/clan/clan-core/src/framework/command.rs:52`:
...
Per `crates/clan/clan-core/src/framework/output.rs:48`:
